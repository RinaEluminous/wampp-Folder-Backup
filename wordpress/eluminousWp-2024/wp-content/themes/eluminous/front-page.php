...
<?php 
            $developementServices = get_field('software_developement_service_title');
            // print_r($developementServices['software_developement_service_subtitle']);
            // exit();
...
<section class="offshore_24" id="Why_Choose_Us">
    ...
    <div class="container">
        <h2 class="sub_title text-center mb-3 mb-xl-4 mx-auto">Acquire Dedicated Software <br> Development Services
            Today!</h2>
        <p class="text-center ml-auto mr-auto f-18"><?php  echo $developementServices['software_developement_service_subtitle'];?></p>
        <div class="bottom_wrap">
            <div class="box blue_bg">
                <span class="offshore_24_title"><?php  echo $developementServices['core_offering_title'];?>
            ...
            <div class="box">
                <span class="offshore_24_title"><?php  echo $developementServices['excellent_additions_title'];?>
            ...
            <div class="review_box">
                <p><img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/home/quote-icon.webp" alt="Call Icon" width="27" height="20" loading="lazy"><?php  echo $developementServices['reviews_stewart'];?></p>
...
<div class="tg-frm page_bottom_form gotForm section-padding">
    ...
    <div class="tabs_scroll">
        <ul class="technology_tabs_menu nav nav-pills" id="pills-tab">
            <li class="nav-item"><a class="nav-link active" id="pills-Web-tab" data-toggle="pill" href="#pills-Web" aria-controls="pills-Web" aria-label="Hire Developers" dataname="pills-Web">Hire Developers</a></li>
            <li class="nav-item"><a class="nav-link" id="custForm-Web-tab" data-toggle="pill" href="#custForm-Web" aria-controls="custForm-Web" aria-label="Hire Developers" dataname="custForm-Web">Custom Plugin Contact Form</a></li>
            
            <li class="nav-item"><a class="nav-link" id="custForm-db-tab" data-toggle="pill" href="#custFormDb-Web" aria-controls="custFormDb-Web" aria-label="Hire Developers" dataname="custForm-Web">Contact Form Entries store in Database</a></li>
        ...
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-Web" role="tabpanel" aria-labelledby="pills-Web-tab">
                <div class="container-custom">
                    ...
                    <?php echo do_shortcode('[contact-form-7 id="3bc81da" title="Contact form 1"]'); ?>
            ...
            <div class="tab-pane fade show" id="custForm-Web" role="tabpanel" aria-labelledby="custForm-Web-tab">
            <div class="container-custom">
                    <h2 class="sub_title text-center mb-1 font-18">Custom  Plugin Contact Form </h2>
                   <?php //echo do_shortcode('[wp-cust-contact-form]'); 
                   echo do_shortcode('[mfg_form id="153" title="test form 2"]'); 
                   ?>
                 </div>
            </div>
            <!-- <div class="tab-pane fade show" id="custForm-Web" role="tabpanel" aria-labelledby="custForm-Web-tab">
            <div class="container-custom">
                    <h2 class="sub_title text-center mb-1 font-18">Custom  Plugin Contact Form </h2>
                   <?php echo do_shortcode('[ccf_contact_form id="96"]'); ?>
                 </div>
            </div> -->

            <div class="tab-pane fade show" id="custFormDb-Web" role="tabpanel" aria-labelledby="custFormDb-Web">
            <div class="container-custom">
                    <h2 class="sub_title text-center mb-1 font-18">Contact Form Entries store in Database </h2>
...
document.addEventListener('DOMContentLoaded', function() {
            var navItemsElements = document.querySelectorAll('.nav-item');

            navItemsElements.forEach(function(navItemElement) {
                navItemElement.addEventListener('click', function(event) {
                    ...
                    var tabPaneElements = document.querySelectorAll('.tab-pane');
                    tabPaneElements.forEach(function(tabPane) {
                        tabPane.classList.remove('active', 'show');
                    });

                    // Add 'active' class to the clicked .nav-link element
                    var clickedNavLink = navItemElement.querySelector('.nav-link');
                    if (clickedNavLink) {
                        clickedNavLink.classList.add('active');
                    }

                    // Get the href attribute to find the corresponding tab-pane
                    var hrefElement = clickedNavLink.getAttribute('href');
                    // console.log('hrefElement >>>',hrefElement);
                    var targetTabPane = document.querySelector(hrefElement);
                    if (targetTabPane) {
