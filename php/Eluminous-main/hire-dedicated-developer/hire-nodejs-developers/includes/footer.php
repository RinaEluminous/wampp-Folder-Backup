...
<!-- country code -->
<script src="<?php echo SITE_URL;?>hire-dedicated-developer/hire-nodejs-developers/build/js/intlTelInput.js"></script>
<script>
...
<!-- country code -->
<script src="<?php echo SITE_URL;?>hire-dedicated-developer/hire-nodejs-developers/js/jquery-ui.js"></script>