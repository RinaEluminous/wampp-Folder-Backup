...
$(document).ready(function() {
    ...
    $('#planForm').validate({
        ...
        submitHandler: function() {
            ...
            var valid = capthchaViewjsPageValidation();
            if (valid == true) {
                $.LoadingOverlay("show", {
                ...
                $.ajax({
                    method: 'POST',
                    url: "<?php echo SITE_URL; ?>/mail-hire-vuejs.php",
                    data: formData,
...
/*$('#make_proposal').on("click", function () {
    var a = capthchaViewjsPageValidation();
    if(a == true){
        $('#planForm').submit();
    }
});*/

function capthchaViewjsPageValidation() {
    ...
    return $("#captchaAnswer").val() ?
        a == t ?
        (jQuery(".viewjsPageCorrectCaptcha").html(""), !0) :
        ($.ajax({
                ...
                success: function(e) {
                    "true" == e ? jQuery(".viewjsPageCorrectCaptcha").html("") : (jQuery(
                        ".viewjsPageCorrectCaptcha").html("Please fill correct captcha"), jQuery(
                        "#cptchaQues").val(e));
                },
            }),
            !1) :
        (jQuery(".viewjsPageCorrectCaptcha").html("Please enter captcha value"), !1);
}
</script>
<!-- country code -->
...
<!-- country code -->
<script src="<?php echo SITE_URL;?>hire-dedicated-developer/hire-vuejs-developers/js/jquery-ui.js"></script>
