...
<?php require_once('../include/header-doc.php');?>
<?php require_once('../include/header-links.php');?>
        ...
        <div class="container">
			...
			We believe that we will be offering the best solution &amp; service to you.
                ...
                <p class="red_btn call_contact call">
                    <a href="<?php echo SITE_URL; ?>hire-dedicated-developer/" class="call_contact btn scroll_form"
                        id="quote">
                        Back to Home Page
                    </a>
                </p>
