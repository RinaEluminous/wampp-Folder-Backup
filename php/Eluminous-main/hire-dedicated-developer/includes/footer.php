...
$(document).ready(function() {
    $('#planForm').validate({
        ...
        submitHandler: function() {
            ...
            var valid = capthchaPageValidation();
            if (valid == true) {
                $.LoadingOverlay("show", {
...
function capthchaPageValidation() {
    ...
    return $("#captchaAnswer").val() ?
        a == t ?
        (jQuery(".PageCorrectCaptcha").html(""), !0) :
        ($.ajax({
                ...
                success: function(e) {
                    "true" == e ? jQuery(".PageCorrectCaptcha").html("") : (jQuery(".PageCorrectCaptcha")
                        .html("Please fill correct captcha"), jQuery("#cptchaQues").val(e));
                },
            }),
            !1) :
        (jQuery(".PageCorrectCaptcha").html("Please enter captcha value"), !1);
}
</script>
<!-- country code -->
...
<!-- country code -->
<script src="<?php echo SITE_URL;?>hire-dedicated-developer/js/jquery-ui.js"></script>