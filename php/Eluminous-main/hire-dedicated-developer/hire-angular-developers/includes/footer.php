...
$(document).ready(function() {
    ...
    $('#planForm').validate({
        ...
        submitHandler: function() {
            ...
            var valid = capthchaAngularPageValidation();
            ...
            if (valid == true) {
                ...
                $.ajax({
                    method: 'POST',
                    url: "<?php echo SITE_URL; ?>/mail-hire-angular-developers.php",
                    data: formData,
...
function capthchaAngularPageValidation() {
    ...
    return $("#captchaAnswer").val() ?
        a == t ?
        (jQuery(".angularPageCorrectCaptcha").html(""), !0) :
        ($.ajax({
                ...
                success: function(e) {
                    "true" == e ? jQuery(".angularPageCorrectCaptcha").html("") : (jQuery(
                        ".angularPageCorrectCaptcha").html("Please fill correct captcha"), jQuery(
                        "#cptchaQues").val(e));
                },
            }),
            !1) :
        (jQuery(".angularPageCorrectCaptcha").html("Please enter captcha value"), !1);
}
</script>
...
<script src="<?php echo SITE_URL;?>hire-dedicated-developer/hire-angular-developers/js/jquery-ui.js"></script>