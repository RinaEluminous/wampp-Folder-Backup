    ...
    $('#planForm').validate({
        ...
        submitHandler: function() {
            ...
            if (valid == true) {
                ...
                $.ajax({
                    method: 'POST',
                    url: "<?php echo SITE_URL; ?>/mail-hire-reactjs-developers.php",
                    data: formData,
...
<!-- country code -->
<script src="<?php echo SITE_URL;?>hire-dedicated-developer/hire-reactjs-developers/js/jquery-ui.js"></script>