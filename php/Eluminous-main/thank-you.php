...
<section class="mb-5 mt-5 thank_you_bg" >
	<div class="container">
		<div class="text-center thank_you">
			<div class="tick_icon text-center col-12"><img src="<?php echo SITE_URL; ?>images/check.png" alt="thank you" class="mt-1 mb-4 img-fluid"></div>
			...
			<h1>Thank You <?php echo !empty($_SESSION['name']) ? $_SESSION['name'] : ''; ?></h1>
			<p><strong>We have received your contact request.</strong> <br>
