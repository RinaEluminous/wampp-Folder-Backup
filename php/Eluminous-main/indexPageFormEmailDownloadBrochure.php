...
if(isset($_REQUEST))
{
	...
	$message = '';
		$subject = 'New Enquiry: '.$email.' has downloaded the brochure';	// Your Email Subject.

		$message .= '<span style="display:block;color:#000;"> Hi Admin, </span>';
		$message .= '<span style="display:block;color:#000;">Received New Enquiry from eLuminous Technologies for Blog Subscription. Please have a look on user detail.Below is the user detail </span>';
      ...
      //send_email_admin("eluminous_se38@eluminoustechnologies.com", "eLuminous", $subject, $mailSubject);
		...
		$subject = 'Your Brochure is here - eLuminous Technologies';	
		$skype_account = "eluminoustechnologies?chat";
		$mailSubject .='<tr><td><span style="font-size:16px;line-height:20px;color:#333;font-family:Segoe UI,Tahoma">Hello ,<br> <br>Here is our Service Brochure for You.<br><br>We are super-excited to assist you in your <strong>Software Development</strong> requirements. Thank you once again for your time and consideration!<br><br>Best Regards,<br>Team eLuminous - Apple Award Winner | Best UI Winner</b><br><br></span></td></tr>';
		include("phpmailer/user_mail_footer.php");
		send_email_user_attachment($email, $email, $subject, $mailSubject,"download-brochure/eluminous-brochure.pdf");
	}
?>