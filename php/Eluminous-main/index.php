...
$metaDesc = "eLuminous Technologies is Trusted IT Partner For Digital Agencies, Tech Startups, Enterprises.We Build Custom Web Design & Development, Mobile, Business Intelligence Solutions For Clients From 27+ Countries.";  require_once 'includes/head.php';
...
<div class="homeBanner homeBannerImg">
    <div class="container bannerTopWrapper">
        <div class="row">
            <div class="col-md-12 col-lg-6">
                <div class="text">
                    ...
                    <div class="clutch_wrapper">
                        <ul>
                            <li><img src="images/clutch-icon.png" alt="clutch" loading="lazy"></li>
                            <li><img src="images/goodfirms.png" alt="goodfirms" loading="lazy"></li>
                        </ul>
                    </div>
            ...
            <div class="col-md-12 col-lg-6">
                <div class="img">
                    <img src="images/banner-image-top.png" alt="Front-End Development" class="img-fluid" width=""
                        height="" />
                </div>
            </div>
        </div>
        ...
        <div class="they_believed_us">
            ...
            <div class="believed_slider">
                <div id="they_believed_us" class="owl-carousel">
                    <div class="client_logo_wrapper"><img src="images/razer.png" alt="Razer" loading="lazy"></div>
                    <div class="client_logo_wrapper"><img src="images/viacom_18.png" alt="Viacom 18" loading="lazy">
                    </div>
                    <div class="client_logo_wrapper"><img src="images/color.png" alt="Colors Viacom" loading="lazy">
                    </div>
                    <div class="client_logo_wrapper"><img src="images/sokule.png" alt="Sokule" loading="lazy"></div>
                    <div class="client_logo_wrapper"><img src="images/mp_inovation.png" alt="Mp Inovations.inc"
                            loading="lazy"></div>
                </div>
            </div>
        </div>
        ...
        <div class=" ">
            ...
            <div class="owlCarousel frameworks_slider">
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/kentico-logo.png" alt="Kentico" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/umbraco.png" alt="Umbraco" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/share-point.png" alt="Share Point" class="img-fluid" loading="lazy">
                </div>
                <!-- new end -->
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/net.png" alt="Microsoft.net" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/shopify.png" alt="Shopify" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/flutter.png" alt="Flutter" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/apple-store.png" alt="Apple Store" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/android.png" alt="Android" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/magento.png" alt="Magento" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/ionic-logo.png" alt="Ionic" class="img-fluid" loading="lazy">
                </div>
                <!-- new -->
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/front_end_development/reactlogo2.png" alt="React" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.4s">
                    <img src="images/front_end_development/angular.png" alt="Angular" class="img-fluid" loading="lazy">
                </div>
                ...
                <div class="frem_work power-bi wow fadeInDown" data-wow-delay="1s">
                    <img src="images/home/power-bi.jpg" alt="Power BI" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work pentaho wow fadeInDown" data-wow-delay="1.2s">
                    <img src="images/home/pentaho.png" alt="Pentaho" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="1.4s">
                    <img src="images/frame_work/laravel.png" alt="Laravel" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="1.6s">
                    <img src="images/frame_work/symfony.png" alt="Symfony" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="1.8s">
                    <img src="images/frame_work/yii_framwork.png" alt="Yii Framwork" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="2s">
                    <img src="images/front_end_development/back_end/postgresql-logo.png" alt="Postgresql"
                        class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="2.2s">
                    <img src="images/web_development/mongo-db-design.png" alt="Mongo DB" class="img-fluid"
                        loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="2.4s">
                    <img src=" images/front_end_development/html_logo.png" alt="HTML" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="2.6s">
                    <img src="images/front_end_development/css_icon.png" alt="CSS" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="2.8s">
                    <img src="images/front_end_development/bootstrap_icon.png" alt="Bootstrap" class="img-fluid"
                        loading="lazy">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="engagement_contant align-items-center d-md-flex container-fluid">
                <div class="overite_image wow fadeInLeft" data-wow-delay="0">
                    <img src="images/team_augmentation.jpg" alt="Team Augmentation" loading="lazy">
                </div>
            ...
            <div class="engagement_contant align-items-center d-md-flex container-fluid tab_column_reverse">
                ...
                <div class="overite_image wow fadeInRight" data-wow-delay="0.4s">
                    <img src="images/fixed_price_projects.jpg" alt="Fixed Price Projects" loading="lazy">
                </div>
            </div>
            <!-- engagement_contant -->
        </div>
                ...
                <div id="testimonials_slider" class="owlCarousel">
                    <div class="text-center text-white">
                        <p>"We have been developing advertising sites online for the past 19 years and for the past 10
                            years eLuminous has done the programming for many of them. You can see our sites and that
                            many of them were done by eLuminous. They do great work and they are reliable and helpful."
                        </p>
                        <div class="username">
                            <div class="profile_img"><img src="images/home/t1.jpg" alt="eluminous testimonials"
                    ...
                    <div class="text-center text-white">
                        <p>"eLuminous Technologies has recently completed our first project with them. I was beyond
                            satisfied with their attention to detail and communication. The final project was completed
                            at the highest standard. The team was committed to ensuring that my team was completely
                            satisfied with the project before it went live. Fantastic organisation, we have recently
                            started our second project with them."</p>
                        <div class="username">
                            <div class="profile_img"><img src="images/home/t2.jpg" alt="eluminous testimonials"
                                    class="img-fluid" loading="lazy"></div>
                            <span>Stewart,
                    ...
                    <div class="text-center text-white">
                        ...
                        <div class="username">
                            <div class="profile_img"><img src="images/home/t3.jpg" alt="eluminous testimonials"
                                    class="img-fluid" loading="lazy"></div>
                            <span>Peter,
                    ...
                    <div class="text-center text-white">
                        <p>"I have used eLuminous Technologies for quite sometime now, and since day one, i have been
                            ...
                            always available and very well versed in communication skills so there isnt a language
                            barrier."</p>
                        <div class="username">
                            <div class="profile_img"><img src="images/home/t4.jpg" alt="eluminous testimonials"
                                    class="img-fluid" loading="lazy"></div>
                            <span>Miguel,
                    ...
                    <div class="text-center text-white">
                        <p>I am very satisfied with the service I received from eLuminous Technologies. The most
                            trustable company I have ever seen. I appreciate their teamwork, intelligence, domain
                            expertise which helped my business to bring it to the next level. I love eLuminous!</p>
                        <div class="username">
                            <div class="profile_img"><img src="images/home/t5.jpg" alt="eluminous testimonials"
                                    class="img-fluid" loading="lazy"></div>
                            <span>Finn Goswami,
                    ...
                    <div class="text-center text-white">
                        <p>"You guys are making all the difference in the world. We had our FIRST SALE on CRM within 30
                            ...
                            project I am going to work with ELUMINOUS"</p>
                        <div class="username">
                            <div class="profile_img"><img src="images/home/t6.jpg" alt="eluminous testimonials"
                                    class="img-fluid" loading="lazy"></div>
                            <span>Matt,
        ...
        <div class="row">
            <ul>
                <li class="wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/home/it_consulting.png" alt="it_consulting" loading="lazy" />
                    <h6><b>IT &amp;</b><br> Consulting </h6>
                </li>
                <li class="wow fadeInDown" data-wow-delay="0.4s">
                    <img src="images/home/ecommerce.png" alt="Ecommerce" loading="lazy" />
                    <h6>Ecommerce</h6>
                </li>
                <li class="wow fadeInDown" data-wow-delay="0.6s">
                    <img src="images/home/banking_finance.png" alt="Banking &amp; Finance" />
                    <h6><b>Banking &amp;</b><br> Finance</h6>
                </li>
                <li class="wow fadeInDown" data-wow-delay="0.8s">
                    <img src="images/home/education.png" alt="Education" loading="lazy" />
                    <h6>Education</h6>
                </li>
                <li class="wow fadeInDown" data-wow-delay="1s">
                    <img src="images/home/entertainment.png" alt="Media &amp; Entertainment" loading="lazy" />
                    <h6><b>Media &amp;</b><br> Entertainment</h6>
                </li>
                <li class="wow fadeInDown" data-wow-delay="1.2s">
                    <img src="images/home/healthcare.png" alt="Healthcare" loading="lazy" />
                    <h6>Healthcare</h6>
                </li>
            </ul>
        </div>
                ...
                <div id="our_insights" class="owl-carousel wow fadeInDown" data-wow-delay="0.4s">
                  ...
                  ?>
                    <div class="blog_wrapper">
                        <a href="<?php echo strip_tags($postUrl);?>" target="_blank">
                        ...
                        <div class="blog_contant">
                            ...
                            <a href="<?php echo strip_tags($postUrl);?>" target="_blank"><i class="fa fa-angle-right"
