	...
	$error='';
	 ...
	 if(empty($_POST["contactNo"])) {
	  ...
	  if($error !='1')
	  {
			...
			$admin2 ="gauri@eluminoustechnologies.com";
			$admin1 ="hrushikeshw@gmail.com ";
			//$admin1 ="designer2@eluminoustechnologies.com";
			//$admin2 ="eluminous_sedk@eluminoustechnologies.com";
			...
			//$resultCont= mail($admin,$subject_admin,$email_admin_temp,$headers);
			//$resultCont1= mail($admin1,$subject_admin,$email_admin_temp,$headers);
