    ...
    <div class="container bannerTopWrapper">
        <div class="row">
            <div class="col-md-8 col-lg-6">
                <div class="text">
                    ...
                    <div class="clutch_wrapper">
                        <ul>
                            <li><img src="images/clutch-icon.webp" alt="clutch" loading="lazy"></li>
                            <li><img src="images/goodfirms.webp" alt="goodfirms" loading="lazy"></li>
                        </ul>
                    </div>
            ...
            <div class="col-md-4 col-lg-6">
                <div class="img">
                    <img src="images/banner-image-top.webp" alt="Front-End Development" class="img-fluid" width=""
                        height="" />
                </div>
            </div>
        </div>
        ...
        <div class="they_believed_us">
            ...
            <div class="believed_slider">
                <div id="they_believed_us" class="owl-carousel">
                    <div class="client_logo_wrapper"><img src="images/razer.webp" alt="Razer" loading="lazy"></div>
                    <div class="client_logo_wrapper"><img src="images/viacom_18.webp" alt="Viacom 18" loading="lazy">
                    </div>
                    <div class="client_logo_wrapper"><img src="images/color.webp" alt="Colors Viacom" loading="lazy">
                    </div>
                    <div class="client_logo_wrapper"><img src="images/sokule.webp" alt="Sokule" loading="lazy"></div>
                    <div class="client_logo_wrapper"><img src="images/mp_inovation.webp" alt="Mp Inovations.inc"
                            loading="lazy"></div>
                </div>
            </div>
        </div>
        ...
        <div class=" ">
            ...
            <div class="owlCarousel frameworks_slider">
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/kentico-logo.webp" alt="Kentico" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/umbraco.webp" alt="Umbraco" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/share-point.webp" alt="Share Point" class="img-fluid" loading="lazy">
                </div>
                <!-- new end -->
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/net.webp" alt="Microsoft.net" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/shopify.webp" alt="Shopify" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/flutter.webp" alt="Flutter" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/apple-store.webp" alt="Apple Store" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/android.webp" alt="Android" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/magento.webp" alt="Magento" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/frame_work/ionic-logo.webp" alt="Ionic" class="img-fluid" loading="lazy">
                </div>
                <!-- new -->
                <div class="frem_work wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/front_end_development/reactlogo2.webp" alt="React" class="img-fluid"
                        loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.4s">
                    <img src="images/front_end_development/angular.webp" alt="Angular" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="0.6s">
                    <img src="images/front_end_development/back_end/node.js.webp" alt="Node js" class="img-fluid"
                        loading="lazy">
                </div>
                ...
                <div class="frem_work pentaho wow fadeInDown" data-wow-delay="1.2s">
                    <img src="images/home/pentaho.webp" alt="Pentaho" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="1.4s">
                    <img src="images/frame_work/laravel.webp" alt="Laravel" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="1.6s">
                    <img src="images/frame_work/symfony.webp" alt="Symfony" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="1.8s">
                    <img src="images/frame_work/yii_framwork.webp" alt="Yii Framwork" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="2s">
                    <img src="images/front_end_development/back_end/postgresql-logo.webp" alt="Postgresql"
                        class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="2.2s">
                    <img src="images/web_development/mongo-db-design.webp" alt="Mongo DB" class="img-fluid"
                        loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="2.4s"">
               <img src=" images/front_end_development/html_logo.webp" alt="HTML" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="2.6s">
                    <img src="images/front_end_development/css_icon.webp" alt="CSS" class="img-fluid" loading="lazy">
                </div>
                <div class="frem_work wow fadeInDown" data-wow-delay="2.8s">
                    <img src="images/front_end_development/bootstrap_icon.webp" alt="Bootstrap" class="img-fluid"
                        loading="lazy">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="engagement_contant align-items-center d-md-flex container-fluid">
                <div class="overite_image wow fadeInLeft" data-wow-delay="0">
                    <img src="images/team_augmentation.webp" alt="Team Augmentation" loading="lazy">
                </div>
            ...
            <div class="engagement_contant align-items-center d-md-flex container-fluid tab_column_reverse">
                ...
                <div class="overite_image wow fadeInRight" data-wow-delay="0.4s">
                    <img src="images/fixed_price_projects.webp" alt="Fixed Price Projects" loading="lazy">
                </div>
            </div>
            <!-- engagement_contant -->
        </div>
            ...
            <div class="col-12">
                ...
                <div id="testimonials_slider" class="owlCarousel">
                    <div class="text-center text-white">
                        ...
                        <div class="username">
                            <div class="profile_img"><img src="images/home/t1.webp" alt="eluminous testimonials"
                    ...
                    <div class="text-center text-white">
                        <p>"eLuminous Technologies has recently completed our first project with them. I was beyond
                            ...
                            them."</p>
                        <div class="username">
                            <div class="profile_img"><img src="images/home/t2.webp" alt="eluminous testimonials"
                                    class="img-fluid" loading="lazy"></div>
                            <span>Stewart,
                    ...
                    <div class="text-center text-white">
                        ...
                        <div class="username">
                            <div class="profile_img"><img src="images/home/t3.webp" alt="eluminous testimonials"
                                    class="img-fluid" loading="lazy"></div>
                            <span>Peter,
                    ...
                    <div class="text-center text-white">
                        ...
                        <div class="username">
                            <div class="profile_img"><img src="images/home/t4.webp" alt="eluminous testimonials"
                                    class="img-fluid" loading="lazy"></div>
                            <span>Miguel,
                    ...
                    <div class="text-center text-white">
                        ...
                        <div class="username">
                            <div class="profile_img"><img src="images/home/t5.webp" alt="eluminous testimonials"
                                    class="img-fluid" loading="lazy"></div>
                            <span>Finn Goswami,
        ...
        <div class="row">
            <ul>
                <li class="wow fadeInDown" data-wow-delay="0.2s">
                    <img src="images/home/it_consulting.webp" alt="it_consulting" loading="lazy" />
                    <h6><b>IT &amp;</b><br> Consulting </h6>
                </li>
                <li class="wow fadeInDown" data-wow-delay="0.4s">
                    <img src="images/home/ecommerce.webp" alt="Ecommerce" loading="lazy" />
                    <h6>Ecommerce</h6>
                </li>
                <li class="wow fadeInDown" data-wow-delay="0.6s">
                    <img src="images/home/banking_finance.webp" alt="Banking &amp; Finance" />
                    <h6><b>Banking &amp;</b><br> Finance</h6>
                </li>
                <li class="wow fadeInDown" data-wow-delay="0.8s">
                    <img src="images/home/education.webp" alt="Education" loading="lazy" />
                    <h6>Education</h6>
                </li>
                <li class="wow fadeInDown" data-wow-delay="1s">
                    <img src="images/home/entertainment.webp" alt="Media &amp; Entertainment" loading="lazy" />
                    <h6><b>Media &amp;</b><br> Entertainment</h6>
                </li>
                <li class="wow fadeInDown" data-wow-delay="1.2s">
                    <img src="images/home/healthcare.webp" alt="Healthcare" loading="lazy" />
                    <h6>Healthcare</h6>
                </li>
            </ul>
        </div>
