...
<section class="p-0">
	<div class="container p-0">
		<div class="row blog_row m-0">
	        ...
	        <h1 class="page-title"><?php printf( __( 'Search Results for : %s', 'eluminous_technologies' ), get_search_query() ); ?></h1>
	         <?php 
						...
						<div class="row m-0">
							...
							<div class="col-lg-12 thumb-img-view">
								...
								<a href="<?php the_permalink(); ?>">
									<img src= "<?php echo $img_src ; ?>" alt="<?php the_title(); ?>" class="img-fluid"></a>
								<?php endif; ?>
							</div>
							<div class="col-lg-12">
	...
	<?php else: ?>
	    ...
	    <div class="wrong-search text-center">

	    	<h2 class="pt-5">

	    		<img src="<?php echo get_template_directory_uri(); ?>/img/404.png" alt="404" class="mb-5"><br>
	    	Sorry, no posts matched your criteria.</h2></div>
			<?php endif; ?>
		</main>
