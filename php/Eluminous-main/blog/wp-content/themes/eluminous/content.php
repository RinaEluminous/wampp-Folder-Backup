...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header page-header">
		...
		<?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			<?php
				...
				if ( $categories_list && eluminous_categorized_blog() ) :
			?>
	...
	<div class="entry-summary">
		<?php the_excerpt(); ?>
		<p><a class="btn btn-default read-more" href="<?php the_permalink(); ?>"><?php _e( 'Continue reading', 'eluminous' ); ?> <i class="fa fa-chevron-right"></i></a></p>
	</div><!-- .entry-summary -->
	<?php else : ?>
	<div class="entry-content">
        ...
        <div class="col-sm-12">
		 ...
		 <div class="col-sm-12"><a class="btn btn-default read-more" href="<?php the_permalink(); ?>"><?php _e( 'Continue Reading', 'eluminous' ); ?> <i class="fa fa-chevron-right"></i></a></div>
