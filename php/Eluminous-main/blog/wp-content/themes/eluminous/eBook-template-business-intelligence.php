...
/* Template Name:  eBook Business Intelligence 
*/
...
if(isset($_REQUEST['btn_submit']) && ($_REQUEST['btn_submit'] !="")){
	...
	$customerMailsubjec	=	"Thank you for downloading Business Intelligence  eBook";

	$AdminMailbody	=	"<p>Dear Admin,</p><p>".$strFirstName." has downloaded <strong>Business Intelligence  eBook</strong>.</p><p>Here are the details: <br/><strong>Name</strong>: ".$strFirstName."<br/><br/><strong>Email</strong>:".$strEmail."</p><p>Team eLuminous</p>";

	$customerMailbody	=	"<p>Dear ".$strFirstName."</p><p>Thank you for showing interest in Business Intelligence  ebook.<p>Team eLuminous</p>";			
...
.popup-form [type="submit"] {
  ...
  background: #2EABFB none repeat scroll 0 0;
...
@media (max-width: 640px){
	...
	.popup-sec img {float: none;}
      ...
      <div class="popup-sec"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/business_intelligence.png" alt="" />
        <h3>Read</h3>
        <h2 style="color:#000;">Business Intelligence  <br/>Trends For 2018</h2>
        ...
        <div class="popup-form">
		 ...
		 if(isset($message) && ($message!="")){
          ...
          <div>
            ...
            <p><a href="http://eluminoustechnologies.com/blog/wp-content/uploads/2018/02/Business-Intelligence-Trends-For-2018-3.pdf" target="_blank">Download Now</a></p>
          </div>
          <?php
		 ...
		 ?>
          <form action="" method="post">
            ...
            <div class="col-last">
              <input name="btn_submit" type="submit" value="Download ebook" id="btnSubmit" style="background:#2EABFB;" />
            </div>
          </form>
          <?php
        ...
        <div class="popup-footer"  style="background-color:#000;"> Your email id is safe with us. We hate SPAM as much as you. </div>
      </div>
    </div>
  </main>
</div>
