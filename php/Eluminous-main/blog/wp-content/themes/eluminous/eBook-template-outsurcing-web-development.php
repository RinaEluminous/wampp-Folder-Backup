...
/* Template Name: eBook Outsurcing*/
...
if(isset($_REQUEST['btn_submit']) && ($_REQUEST['btn_submit'] !="")){
	...
	$customerMailsubjec	=	"Thank you for downloading Outsourcing Web Developing eBook";

	$AdminMailbody	=	"<p>Dear Admin,</p><p>".$strFirstName." has downloaded <strong>Outsourcing Web Developing eBook</strong>.</p><p>Here are the details: <br/><strong>Name</strong>: ".$strFirstName."<br/><br/><strong>Email</strong>:".$strEmail."</p><p>Team eLuminous</p>";

	$customerMailbody	=	"<p>Dear ".$strFirstName."</p><p>Thank you for showing interest in Outsourcing Web Developing ebook.<p>Team eLuminous</p>";			
...
@media (max-width: 640px){
	...
	.popup-sec img {float: none;}
      ...
      <div class="popup-sec"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/outsourcing.jpg" alt="" />
        <h3>Read</h3>
        <h2 style="color:#000;">The New Approch for  <br/>Outsourcing Web Development</h2>
        ...
        <div class="popup-form">
		 ...
		 if(isset($message) && ($message!="")){
          ...
          <div>
            ...
            <p><a href="<?php echo site_url();?>/wp-content/uploads/2017/05/outsurcing-web-development-has-all-new-Mean-1.pdf" target="_blank">Download Now</a></p>
          </div>
          <?php
		 ...
		 ?>
          <form action="" method="post">
            ...
            <div class="col-last">
              <input name="btn_submit" type="submit" value="Download ebook" id="btnSubmit" style="background:#066B96;" />
            </div>
          </form>
          <?php
