...
<section class="p-0">
	<div class="container p-0">
		<div class="row blog_row m-0">
			<div id="primary" class="content-area col-sm-12 pt-sm-4 col-md-7 pt-lg-5 pb-5 col-lg-8 pt-lg-3 pt-md-5">
				<main id="main" class="site-main pt-lg-4" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						<div class="row m-0">
							<div class="col-lg-6 pl-0 pr-0 col-sm-12 pt-4 pt-lg-0 pt-md-4">
								<?php
							...
							<div class="pl-lg-0 pr-0 col-lg-6 col-sm-12 pl-xl-5 pt-sm-4 pt-4 pt-lg-0">
			...
			<div class="col-sm-12 col-md-5 drop-shaddow-section pt-lg-5 pb-5 col-lg-4 pt-lg-3  pt-md-5">
