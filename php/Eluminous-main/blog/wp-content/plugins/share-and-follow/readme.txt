...
Designed for average users to use, ideal for developers who want to save time, this plugin gives links to the most prominent Social Networking sites for sharing and following, presented in many different formats (widgets/shortcode/template tag/auto added). Optional subscriptions for extra 22 icons sets.
