...
// This is to prevent issues with New Relics auto injection of code.
...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<h1>XML Sitemap - Generated by Spokal</h1>
					...
					<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
						...
						<p class="expl"><a href="' . esc_url( home_url( 'sp-sitemap.xml' ) ) . '">&#8593; Sitemap Index</a></p>
						<table id="sitemap" cellpadding="3">
							<thead>
								<tr>
									<th width="75%">URL</th>
				...
				<script type="text/javascript" src="' . plugins_url( 'js/sp_sitemaps_jquery.js', SpokalVars::getInstance()->file ) . '"></script>
