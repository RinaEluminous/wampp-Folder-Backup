...
Plugin URI: http://wphelpline.com/bing-site-verification-using-meta-tag
    ...
    <div class="icon32" id="icon-options-general"><br /></div>
		...
		<form name="form1" id="form1" method="post" action="options.php">
			...
			<p style="font-size:0.95em"><?php 
				_e( sprintf( 'You may post a comment on this plugin\'s %1$shomepage%2$s if you have any questions, bug reports, or feature suggestions.', '<a target="_blank" href="http://wphelpline.com/bing-site-verification-using-meta-tag" rel="help">', '</a>' ) ); ?></p>
