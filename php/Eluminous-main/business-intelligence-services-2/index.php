...
$adminMail_3		=	'sam@eluminoustechnologies.com';
...
<meta name="keywords" itemprop="keywords" content="ETL developers, BI developers, business intelligence services, bi tools, pentaho developers, qlikview developers,  tableau developers, msbi developers"/>
<script>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-sm-8 col-xs-6">
        <div class="contact-info"> <span><i class="fa fa-phone" aria-hidden="true"></i> +1 646 688 3509</span> <span><i class="fa fa-envelope" aria-hidden="true"></i> sales@eluminoustechnologies.com</span> </div>
      </div>
      ...
      <div class="col-md-9 col-sm-9 col-xs-12">
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="nav navbar-nav">
            ...
            <li><a href="http://eluminoustechnologies.com/blog/category/business-intelligence/" target="_blank">Blog</a></li>
...
<section id="main-header">
  <div class="container">
    <div class="row">
    <div class="col-md-8">
    <img src="images/header-img-new.jpg">
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="col-md-6"><h4>Data Analytics &amp; BI Dashboards isn't just for Biggies. It helps to get Business insights &amp; enables focus on action.</h4><h4>Business Leaders are heavily investing in data science, business intelligence to deal with complexity &amp; KPI.<!--<h4--></h4></div>
...
<section id="etl">
	<div class="container">
    	<div class="row">
        	<div class="col-md-12">
       				<div class="etlWrapper">
                		<h2>ETL</h2>
                        <div class="etlQus">
                        <h3>Do you want to transform your business’s huge data into actionable insights?</h3>
                        <h3>What if you could get a competent team of ETL Developers to help you providing cost-effective &amp; right business decision support with optimal reporting system?</h3></div><p>At eLuminous, we are here to help you out. We are a pool of professional business intelligence developers you are searching for, committed to helping businesses just like you. We are able to deliver consulatation, reporting, monitoring, business decision support from highly qualified business intelligence consultants.</p>
                    </div> 
                    <img src="images/data-warehous.jpg" alt="Data Warehouse">   
             </div>   
        </div>
    </div>
</section>
...
<section id="section-5">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
       <div class="case-sec"> <img src="images/img-4.png" alt="">
          ...
          <a href="http://eluminoustechnologies.com/wp-content/uploads/2014/08/Tyre-manufacturing-case-study.pdf" target="_blank">Read More</a> </div>
        ...
        <div class="case-sec"> <img src="images/img-1.png" alt="">
          ...
          <a href="http://eluminoustechnologies.com/wp-content/uploads/2014/08/Job-portal-reporting.pdf" target="_blank">Read More</a> </div>
        <div class="case-sec"> <img src="images/img-2.png" alt="">
          ...
          <a href="http://eluminoustechnologies.com/wp-content/uploads/2014/08/Developing-MAR.pdf" target="_blank">Read More</a> </div>
        <div class="case-sec  no-border"> <img src="images/img-3.png" alt="">
          ...
          <a href="http://eluminoustechnologies.com/wp-content/uploads/2014/08/Business-Challenge1.pdf" target="_blank">Read More</a> </div>
...
<footer>
  <div class="container">
    <p>Copyright &copy; <?php echo date('Y');?> eLuminous technologies Pvt. Ltd.</p>
  </div>
...
a.src=document.location.protocol+"//script.crazyegg.com/pages/scripts/0061/0201.js?"+Math.floor(new Date().getTime()/3600000);
...
<div class="sticky-popup right-bottom open_sticky_popup popup-content-bounce-in-up" style="bottom: -402px;left: -30px; visibility: visible;"><div class="popup-wrap"><div class="popup-header"><span class="popup-title">GET IN TOUCH<div class="popup-image"></div></span></div><div class="popup-content"><div class="popup-content-pad"><div role="form" class="wpcf7" id="wpcf7-f1325-o2" lang="en-US" dir="ltr">
<div class="screen-reader-response"></div>
