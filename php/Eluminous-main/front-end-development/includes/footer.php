        ...
        <div class="row">
            <div class="col-lg-6 col-md-7  footer-con">
                ...
                <ul class="footer-link">
                    <li> <a href="https://eluminoustechnologies.com/terms-and-conditions/">Terms &amp; Conditions</a></li>
...
<!-- <button class="scrollToTop" style="display: inline-block; right: -50px;">
    <img src="<?php echo SITE_URL;?>images/icons/white-up-arrow.png" alt="Scroll Top Icon">
</button> -->
...
<script async='async' src="<?php echo SITE_URL;?>front-end-development/assets/wow/wow.min.js"></script>
...
function capthchaPageValidation() {
    ...
    return $("#captchaAnswer").val() ?
        a == t ?
        (jQuery(".frontEndPageCorrectCaptcha").html(""), !0) :
        ($.ajax({
                ...
                success: function(e) {
                    "true" == e ? jQuery(".frontEndPageCorrectCaptcha").html("") : (jQuery(
                        ".frontEndPageCorrectCaptcha").html("Please fill correct captcha"), jQuery(
                        "#cptchaQues").val(e));
                },
            }),
            !1) :
        (jQuery(".frontEndPageCorrectCaptcha").html("Please enter captcha value"), !1);
}
</script>
...
<!-- country code -->
<!--booking-slot-->
<script src="<?php echo SITE_URL;?>front-end-development/js/jquery-ui.js"></script>
<script>
