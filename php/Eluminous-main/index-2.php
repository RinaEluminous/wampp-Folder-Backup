...
$metaDesc = "eLuminous Technologies is Trusted IT Partner For Digital Agencies, Tech Startups, Enterprises.We Build Custom Web Design & Development, Mobile, Business Intelligence Solutions For Clients From 27+ Countries.";  require_once 'assets/files/header.php'; 
    ...
    <div class="container text-center">
        <h2>
            ...
            <ul class="portfolio_list">
                <li class="wow fadeInDown" data-wow-delay="0"><span>2000+</span> Websites Developed</li>
                <li class="wow fadeInDown" data-wow-delay="0.6s"><span>500+</span> E-commerce Websites Developed</li>
                <li class="wow fadeInDown" data-wow-delay="0.8s"><span>500+</span> Mobile Apps Developed</li>
            </ul>
        </h2>
...
<section id="industries_served">
    <h2 class="text-center">Industries Served
        <small>16+ Years of journey, more than a service</small>
    </h2>
    <div class="container">
        <div class="row">
            <ul>
