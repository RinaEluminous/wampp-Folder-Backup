...
$pageTitle = "Wokza";// Default Page title
$metaDesc = "Wokza is the website which have buyer and sellers users. ";// Default metaDesc
$keywords = "Wokza";// Default 
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-md-7">
                <div id="photo-slider">
                    <div class="slider-for">
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/wokza/wokza.jpg" alt="image"
                                draggable="false" / class="img-fluid" loading="lazy">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/wokza/wokza1.jpg" alt="image"
                                draggable="false" / class="img-fluid" loading="lazy">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/wokza/wokza2.jpg" alt="image"
                                draggable="false" / class="img-fluid" loading="lazy">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/wokza/wokza3.jpg" alt="image"
                                draggable="false" / class="img-fluid" loading="lazy">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/wokza/wokza4.jpg" alt="image"
                                draggable="false" / class="img-fluid" loading="lazy">
                        </div>
            ...
            <div class="col-md-5 gray_bg d-flex align-items-center ">
                <div class="project_details align-self-center">
                    ...
                    <h6>Description:<br>
                        <small>Wokza is the website which have buyer and sellers users. This website support
                            multi-vendor functionality, where seller need to pay fees to upload product on website.
                            Seller can set minimum order quantity to purchase products.</small>
                    </h6>

                    <ul class="p_listing">
                        <li>Multi-vendor functionality.</li>
                        <li>User can register as Buyer, Seller or Both.</li>
                        <li>Request for quotations for products.</li>
                        <li>Chat functionality integrated.</li>
                        <li>PayFast payment gateway integrated.</li>
                    ...
                    <div class="scrool_expertise text-left">
                        <a href="http://eluminousdev.in/wokza/" target="_blank"
