...
$pageTitle = "Publisher’s Internationalé";// Default Page title
$metaDesc = "This website is Australia’s leading media agency called “Publishers Internationale”.";// Default metaDesc
$keywords = "Publisher’s Internationalé, Media Website Development";// Default 
...
<section class="inner_banner">
    ...
    <div class="inner_page_title">
        <div class="container">
            <h1>Publisher’s Internationalé <small></small></h1>
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-md-7">
                <div id="photo-slider">
                    <div class="slider-for">
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/pubintl/pubintl.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/pubintl/pubintl2.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/pubintl/pubintl3.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/pubintl/pubintl4.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/pubintl/pubintl5.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
            ...
            <div class="col-md-5 gray_bg d-flex align-items-center ">
                <div class="project_details align-self-center">
                    ...
                    <h6>Description:<br>
                        <small>
                            This website is made for one of our Australian client who owns Australia’s leading media
                            agency called “Publishers Internationale”. This website is fully informative and it gives
                            the data about PI for their services, Team, Promotions, Portfolio and a complete list of
                            publishers (media) with whom they are having agreements (tie-ups).
                        </small>
                    </h6>

                    <ul class="p_listing">
                        <li>Corporate and company branding website for the publishing industry.</li>
                    ...
                    <div class="scrool_expertise text-left">
                        <a href="http://www.pubintl.com.au/" target="_blank"
