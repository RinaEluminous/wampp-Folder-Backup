        ...
        <div class="row justify-content-between">
            ...
            <div class="col-md-7">
                <div id="photo-slider">
                    <div class="slider-for">
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/koroga-party/koroga-party.jpg"
                                alt="image" draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/koroga-party/koroga-party1.jpg"
                                alt="image" draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/koroga-party/koroga-party2.jpg"
                                alt="image" draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/koroga-party/koroga-party3.jpg"
                                alt="image" draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/koroga-party/koroga-party4.jpg"
                                alt="image" draggable="false" / class="img-fluid">
                        </div>
            ...
            <div class="col-md-5 gray_bg d-flex align-items-center ">
                <div class="project_details align-self-center">
                    ...
                    <h6>Description:<br>
                        <small>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nostrum ut ipsam provident
                            explicabo hic fuga! Optio aliquid molestias odit aspernatur itaque praesentium doloremque
                            quod repellat, ad. Sequi, id quasi nisi..
                        </small>
                        <small>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam rerum ullam esse
                            molestiae quasi fuga nisi autem voluptates, iste ex aut facere eum veritatis culpa. Libero
                            voluptas adipisci voluptatibus laudantium!</small>
                    </h6>
                    ...
                    <div class="scrool_expertise text-left">
                        <a href="http://korogaparty.co.uk/" target="_blank"
