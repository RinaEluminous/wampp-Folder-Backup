...
$pageTitle = "Dealer Pro";// Default Page title
$metaDesc = "This is a Mobile site plugin for WordPress which helps the users to insert the data from the backend panel of WordPress and it gets displayed on the Mobile website along with the web services.";// Default metaDesc
$keywords = "Dealer Pro, Mobile Site Plugin for WordPress";// Default 
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-md-7">
                <div id="photo-slider">
                    <div class="slider-for">
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/tsl/tsl.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/tsl/tsl1.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/tsl/tsl2.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
            ...
            <div class="col-md-5 gray_bg d-flex align-items-center ">
                <div class="project_details align-self-center">
                    ...
                    <h6>Description:<br>
                        <small>
                            This is a Mobile site plugin for WordPress which helps the users to insert the data from the
                            backend panel of WordPress and it gets displayed on the Mobile website along with the web
                            services.
                        </small>
                    </h6>
                    ...
                    <div class="scrool_expertise text-left">
                        <a href="http://www.tsl.co.th/index/" target="_blank"
