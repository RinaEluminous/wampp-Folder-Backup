...
$pageTitle = "Grand Ballroom";// Default Page title
$metaDesc = "An informative website for one of our client who wanted to promote their grand ballroom and its services.";// Default metaDesc
$keywords = "Grand Ballroom, WordPress Website Design";// Default 
...
<section class="inner_banner">
    ...
    <div class="inner_page_title">
        <div class="container">
            <h1>Grand Ballroom<small></small></h1>
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-md-7">
                <div id="photo-slider">
                    <div class="slider-for">
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/grandballroom/grandballroom.jpg"
                                alt="image" draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/grandballroom/grandballroom2.jpg"
                                alt="image" draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/grandballroom/grandballroom3.jpg"
                                alt="image" draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/grandballroom/grandballroom4.jpg"
                                alt="image" draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/grandballroom/grandballroom5.jpg"
                                alt="image" draggable="false" / class="img-fluid">
                        </div>
            ...
            <div class="col-md-5 gray_bg d-flex align-items-center ">
                <div class="project_details align-self-center">
                    ...
                    <h6>Description:<br>
                        <small>
                            This is an informative website for one of our client who wanted to promote their grand
                            ballroom and its services. It’s a simple WordPress site that gives an information about the
                            sitting arrangements and the banquet room plan of the ballroom.
                        </small>
                    </h6>
                    ...
                    <div class="scrool_expertise text-left">
                        <a href="http://www.grandballroom.in/" target="_blank"
