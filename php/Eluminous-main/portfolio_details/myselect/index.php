...
$pageTitle = "My Select";// Default Page title
$metaDesc = "This site is used to calculate and compare price for coffee machines based on number of works, working days etc. ";// Default metaDesc
$keywords = "My Select";// Default 
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-md-7">
                <div id="photo-slider">
                    <div class="slider-for">
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/myselect/myselect.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/myselect/myselect1.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/myselect/myselect2.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/myselect/myselect3.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/myselect/myselect4.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
            ...
            <div class="col-md-5 gray_bg d-flex align-items-center ">
                <div class="project_details align-self-center">
                    ...
                    <h6>Description:<br>
                        <small>This site is used to calculate and compare price for coffee machines based on number of
                            works, working days etc.</small>
                    </h6>
                    <h6>Skills:</h6>
                    ...
                    <div class="scrool_expertise text-left">
                        <a href="http://www.myselect.ca/" target="_blank"
