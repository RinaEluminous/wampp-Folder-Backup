        ...
        <div class="row justify-content-between">
            ...
            <div class="col-md-7">
                <div id="photo-slider">
                    <div class="">
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/flashcards/flashcards.jpg" alt="image"
            ...
            <div class="col-md-5 gray_bg d-flex align-items-center ">
                <div class="project_details align-self-center">
                    ...
                    <h6>Description:<br>
                        <small>
                            <b>Business problem:</b> Payment gateway had points as its currency. Purchasing
                            articles/services from mobile applications using these points as currency was not possible.
                            It was limited only to the website.
                        </small>
                        <small>
                            <b>Solution in brief:</b> Developed an integration SDK bundle (Library) which can be used by
                            Android app developer to make use of this points related payment gateway in the developed
                            app itself.
                        </small>
                    </h6>
