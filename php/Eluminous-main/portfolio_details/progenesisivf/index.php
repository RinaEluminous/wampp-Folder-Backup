...
$pageTitle = "Progenesis";// Default Page title
$metaDesc = "This website belongs to healthcare industry. It is an informative site about Fertility Treatments & Procedures, Pregnancy Plan etc.";// Default metaDesc
$keywords = "Progenesis, Healthcare Website Design, Healthcare Website Design Agency";// Default 
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-md-7">
                <div id="photo-slider">
                    <div class="slider-for">
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/progenesisivf/progenesisivf.jpg"
                                alt="image" draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/progenesisivf/progenesisivf2.jpg"
                                alt="image" draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/progenesisivf/progenesisivf3.jpg"
                                alt="image" draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/progenesisivf/progenesisivf4.jpg"
                                alt="image" draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/progenesisivf/progenesisivf5.jpg"
                                alt="image" draggable="false" / class="img-fluid">
                        </div>
            ...
            <div class="col-md-5 gray_bg d-flex align-items-center ">
                <div class="project_details align-self-center">
                    ...
                    <h6>Description:<br>
                        <small>
                            This website belongs to healthcare. It is an informative site about Fertility Treatments &
                            Procedures, Pregnancy Plan etc.
                        </small>
                    </h6>
                    ...
                    <div class="scrool_expertise text-left">
                        <a href="http://www.progenesisivf.com/" target="_blank"
