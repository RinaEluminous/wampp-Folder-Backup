        ...
        <div class="row justify-content-between">
            ...
            <div class="col-md-7">
                <div id="photo-slider">
                    <div class=" ">
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/Kulesearch/Kulesearch.jpg" alt="image"
            ...
            <div class="col-md-5 gray_bg d-flex align-items-center ">
                <div class="project_details align-self-center">
                    ...
                    <h6>Description:<br>
                        <small>
                            Kulesearch is a search engine which is integrated with all leading search engines, Social
                            networking sites etc. It also offers the “buy” & “sell” keywords and many of the marketing
                            tools like advertising, sponsored search results with options to add links to search engine
                            DB, allows you to create search engine friendly articles and much more.
                        </small>
                    </h6>
                    ...
                    <div class="scrool_expertise text-left">
                        <a href="http://www.kulesearch.com/" target="_blank"
