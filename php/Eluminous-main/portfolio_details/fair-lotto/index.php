        ...
        <div class="row justify-content-between">
            ...
            <div class="col-md-7">
                <div id="photo-slider">
                    <div class="slider-for">
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/fair-lotto/fair-lotto.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/fair-lotto/fair-lotto1.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/fair-lotto/fair-lotto2.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/fair-lotto/fair-lotto3.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
                        <div class="item">
                            <img src="<?php echo SITE_URL;?>/portfolio_details/fair-lotto/fair-lotto4.jpg" alt="image"
                                draggable="false" / class="img-fluid">
                        </div>
            ...
            <div class="col-md-5 gray_bg d-flex align-items-center ">
                <div class="project_details align-self-center">
                    ...
                    <h6>Description:<br>
                        <small>A play lotto multilingual website, where users register and play lotto. Users login to
                            the website to play lotto.</small>
                        <small>Lotto 6 in 36 option and Super 7 option are available for users to select their numbers.
                            Winning numbers will be updated /decided at the end of each week.</small>
                    </h6>
                    <h6>Skills:</h6>
                    ...
                    <div class="scrool_expertise text-left">
                        <a href="http://fair-lotto.org/index.php?lang=en" target="_blank"
