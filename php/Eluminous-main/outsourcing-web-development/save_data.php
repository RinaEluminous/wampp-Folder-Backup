...
$customerMailsubject	=	'Thank you for showing the interest in this amazing offer - eLuminous Technologies';
...
//-----------------Add user to mailchimp list start----------------------
  ...
  if($email !== '') {
    ...
    $return_value = $api->listSubscribe( $listId, $strPopEmail, $merge_vars, 'html', false, false, true, true );
